...
import { Pressable, View, Text, SafeAreaView, PlatformColor, Platform } from 'react-native'
import { StyleSheet, UnistylesRuntime, StyleSheetValues } from 'react-native-unistyles'

type DynamicProps = {
    width?: StyleSheetValues['width'];
    height?: StyleSheetValues['height'];
    backgroundColor?: StyleSheetValues['backgroundColor'];
};
