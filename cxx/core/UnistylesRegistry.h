...
struct UnistylesRegistry: public StyleSheetRegistry {
    ...
    void linkShadowNodeWithUnistyle(jsi::Runtime& rt, const ShadowNodeFamily*, std::vector<core::Unistyle::Shared>& unistyles, Variants& variants, std::vector<std::vector<folly::dynamic>>&, std::optional<std::string> scopedTheme, std::optional<std::string> uniquePressableId, std::function<folly::dynamic(std::shared_ptr<UnistyleData>)> onRegister);
