...
By default `Animated` components will flatten your styles array. This means that you can only pass **single** unistyle to `Animated` components.
If you want to get rid of this warning, for `react-native-reanimated` 3.x please follow [this thread](https://github.com/jpudysz/react-native-unistyles/issues/512) to apply a patch.
