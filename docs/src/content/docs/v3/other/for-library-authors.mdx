...
`StyleSheet.configure` **must** be invoked as soon as possible, before user's code references any `StyleSheet` from your library.
...
You can also consider publishing your UI kit with bebel transforms in place. Keep in mind that it could break [testing](/v3/start/testing) views with your components.
