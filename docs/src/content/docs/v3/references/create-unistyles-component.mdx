...
That’s why we created a way to register such component to Unistyles updates.
...
TypeScript will autocomplete all your props, so there is no need to specify them manually.
