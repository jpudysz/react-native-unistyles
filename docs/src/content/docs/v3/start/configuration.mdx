...
<Aside>
Unistyles supports any dynamic theme and doesn't enforce any specific structure. To prevent TypeScript issues make sure that every theme has the same type.
</Aside>
