...
Unistyles allows you to update your theme during runtime. This is useful if you want to show the user interface with default colors and later alter them based on user preferences. 

If you update the currently selected theme, it will be automatically applied, and Unistyles will notify all stylesheets about the change. Otherwise, the theme will be updated silently.
