...
**Bare React Native** users can use React Native's built-in `enableEdgeToEdge` gradle property or optionally install the package for ecosystem compatibility.
