...
<Aside type="tip" title="Enable edgeToEdgeEnabled in gradle.properties">
...
Since v3.1.0, `react-native-edge-to-edge` is optional — you can still install it for ecosystem compatibility.
