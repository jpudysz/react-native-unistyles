  ...
  struct JSIConverter<Orientation> {
    static inline Orientation fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        ...
        default: [[unlikely]]
          throw std::runtime_error("Cannot convert " + unionValue + " to Orientation - invalid value!");
      }
    }
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      switch (hashString(unionValue.c_str(), unionValue.size())) {
        case hashString("portrait"): return true;
        case hashString("landscape"): return true;
